<script lang="ts">
    ...
    import {ArrowRight, Eye, EyeOff, Flame, Lock, Mail} from 'lucide-svelte';
    ...
    <div class="auth-form-side">
        <div class="auth-form-container">
            <div class="auth-header">
                ...
                <div class="auth-subtitle">Sign in to your account to continue chatting.</div>
            </div>
            ...
            <div class="auth-footer">
                Don't have an account? <a href="/register" class="auth-footer-link">Create one</a>
            </div>
        </div>
    </div>
</div>
